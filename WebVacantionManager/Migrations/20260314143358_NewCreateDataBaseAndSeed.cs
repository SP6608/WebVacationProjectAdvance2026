...
{
    /// <inheritdoc />
    public partial class NewCreateDataBaseAndSeed : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1f1a1111-1111-1111-1111-111111111111", 0, "9fa48a00-f7a2-44c7-bbfc-19d2ae9d0fbe", "ceo@company.com", true, "Ivan", "Petrov", false, null, "CEO@COMPANY.COM", "CEO@COMPANY.COM", "AQAAAAIAAYagAAAAECojRaduCFZLSoo8NfySCSvqB2NeXe6OabCxxNQXG2DNhQve5inOGnqlHlleeGOCQg==", null, false, "d8ccfbe4-74f6-4b5b-90a4-26fa9db520a1", null, false, "ceo@company.com" },
                    { "2f2b2222-2222-2222-2222-222222222222", 0, "58d35569-e086-42ec-b586-083ff43896b8", "teamlead@company.com", true, "Maria", "Ivanova", false, null, "TEAMLEAD@COMPANY.COM", "TEAMLEAD@COMPANY.COM", "AQAAAAIAAYagAAAAEAZD9r/gIfnjyqfvLXBv7qfRLE4NR5JD627eFKcWlybfl6JwKroPha21HaY6BE+CqA==", null, false, "a2a08b2e-898d-42d8-8b51-6c2185b4859c", null, false, "teamlead@company.com" },
                    { "3f3c3333-3333-3333-3333-333333333333", 0, "ed8f6b5e-00c0-466f-863d-e955ef9352dd", "developer@company.com", true, "Georgi", "Dimitrov", false, null, "DEVELOPER@COMPANY.COM", "DEVELOPER@COMPANY.COM", "AQAAAAIAAYagAAAAEIG1yn7yePE2B0bGW5AN6p2piusAxtIi8AOXQE2YJgDsYN1Zs1pH2gZhvSIJs573tw==", null, false, "94f11d31-bdf5-485c-8a22-6708c3b94c3e", null, false, "developer@company.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "3a310333-c4a5-4457-9065-a861e635d848", "1f1a1111-1111-1111-1111-111111111111" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 3, "2f2b2222-2222-2222-2222-222222222222", "Backend Team" },
                    { 2, 4, "2f2b2222-2222-2222-2222-222222222222", "Frontend Team" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "1f1a1111-1111-1111-1111-111111111111", new DateTime(2026, 3, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2026, 3, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2026, 3, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), false, false, 2 }
                });
